...
$(document).ready(function (){
  ...
  $('#newProspect').one('click',function (){
    ...
    $('#propertyNameSelect2').val(property_id).trigger('change');
    $('#propertyCodeSelect2').val(property_id).trigger('change');
    $('#usage_action_master_id').val(usage_id);
    $('#prospect_room').val(propertyRoomName);
  })
