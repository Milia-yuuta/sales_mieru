              ...
              <div class="f">
                <div class="f_parts">
                  ...
                  <div class="f_parts" data-option="style-date">
                    <input type="text" style="margin-top: 10px" id="prospect_action_log_datepicker" name="date" placeholder="<?php date_default_timezone_set('Asia/Tokyo'); echo date('Y.m.d'); ?>" value="" autocomplete="off" readonly required>
                  </div>
                </div>
              </div>
            </div>
...
{{--              </li>--}}
    ...
    <div class="foot">
      <div class="btnarea">
        <button class="btn" data-option="w-full" id="prospect_action_log_submit">追客登録</button>
      </div>
    </div>
  </form>
  <script>
